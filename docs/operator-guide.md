...
- safety-critical escalation path (paint/solvent VOC exposure,
  etching-chemical handling, precision hand-tool/equipment condition)
...
- a hard, unconditional block on any attempt to route a
  painting/engraving-execution decision, a workshop-chemical-safety-
  clearance decision, or a shop-safety-officer-override decision,
  through this actor — those decisions stay the shop safety officer's
...
painting/engraving-execution decision, a workshop-chemical-safety-
clearance decision, or a shop-safety-officer judgment override through
this actor.
