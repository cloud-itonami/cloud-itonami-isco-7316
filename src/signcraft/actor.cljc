(ns signcraft.actor
  "SignCraftActor — the ISCO-08 7316 signwriting / decorative-painting
  / engraving / etching workshop scheduling/logistics coordination
  ...
  resume after human sign-off. Modeled on cloud-itonami-isco-7321's
  prepresstech.actor for the precision-craft/chemical-hazard-workshop
  shape.
  ...
  The unconditional invariant: the Sign & Decorative Craft Advisor can
  never directly commit an operating record the SignCraftGovernor
  refuses, and can never make this actor finalize a
  painting/engraving-execution decision (e.g. a specific signwriting,
  decorative-painting, engraving or etching procedure) or a
  workshop-chemical-safety-clearance decision, nor override a shop
  ...
  SCHEDULING/LOGISTICS ONLY — it never performs signwriting,
  decorative-painting, engraving or etching work itself."
...
(defn build-graph
  "Build a compiled SignCraftActor graph. `store` implements
  `signcraft.store/Store`. `advisor` implements
  `signcraft.advisor/Advisor` (defaults to `mock-advisor`).
