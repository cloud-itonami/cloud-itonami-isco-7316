...
`cloud-itonami-isco-7316` accepts contributions to the OSS actor, policy tests,
...
- Do not commit real worker, workshop or operator data, credentials or
  operating documents.
- Keep production writes and disclosures behind SignCraft Governor.
...
- Never widen the closed op-allowlist to include a
  painting/engraving-execution op, a workshop-chemical-safety-
  clearance op, or a shop-safety-officer-override op, without a
